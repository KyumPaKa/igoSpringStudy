...
/*        border-left: 1px solid #c0c0c0;*/
    ...
    <div id="nav_menu">
        <ul>
            ...
            <li>
                <a href="${path}/admin/blacklist.do">블랙리스트 목록</a>
            </li>
            <li>
                <a href="${path}/admin/sanction.do">신고내역</a>
            </li>
            <li>
                <a href="${path}/admin/level.do">등급관리</a>
            </li>
            <li>
                <a href="${path}/notice/write.do">공지글 작성</a>
            </li>
        </ul>
    </div>
    ...
    <div id="nav_menu_right">
		...
		<li>
			<a href="${path}/user/logout.do">Logout_admin</a>
		</li>
		<li>
