...
<table border="1" style="width: 1000px;">
	<tr>
		...
		<form id="replyForm" onsubmit="return false;">
			<input type="hidden" name="refIdx" id="refIdx">
			<input type="text" id="content" name="content" placeholder="댓글을 작성해주세요." style="width: 100%;">
		</form>
		</td>
		<td style="text-align: center;">
	...
	<tr>
		...
		익명작성자 | <fmt:formatDate value="${row.regDate}" pattern="yyyy년 MM월 dd일 hh시 mm분 ss초" />
		<c:if test="${row.groupNo == 1}">
